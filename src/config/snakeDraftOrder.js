...
export const SNAKE_DRAFT_ORDER = [
  ...
  { abbr: 'MENDL', name: 'Mendel Lapse', owner: 'Arnie', slots_hit: 13, slots_pit: 9, slots: 38, budget: 300 },
  { abbr: 'BEDST', name: 'Bed Stuy Fish Fry', owner: 'Jeff J. (me)', slots_hit: 13, slots_pit: 9, slots: 38, budget: 300 },
  { abbr: 'CL21B', name: '21 Club 2', owner: 'Marty', slots_hit: 13, slots_pit: 9, slots: 38, budget: 300 },
  ...
  { abbr: 'JAYHK', name: 'Jayhawks', owner: 'Jay', slots_hit: 13, slots_pit: 9, slots: 38, budget: 300 },
  ...
  { abbr: 'INGBT', name: 'Inglorious Batters', owner: 'Matt B.', slots_hit: 13, slots_pit: 9, slots: 38, budget: 300 },
]
